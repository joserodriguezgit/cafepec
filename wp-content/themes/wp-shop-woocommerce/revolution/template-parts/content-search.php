		...
		<div class="entry-content">
			<?php
				...
				if ( is_singular() ) :
					...
					?>
					<a href="<?php the_permalink(); ?>" class="btn read-btn text-uppercase"> <?php echo esc_html(get_theme_mod('wp_shop_woocommerce_read_more_text', __('Continue Reading....', 'wp-shop-woocommerce'))); ?> </a>
					<?php
				endif;
				?>
